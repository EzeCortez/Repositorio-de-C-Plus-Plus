...
public class Guardia : Persona
{
    ...
    public string controlarDocumento(Visitante personaVisitante)
{
    return $"Adelante {personaVisitante.getNombre()} {personaVisitante.getApellido()} con dni {personaVisitante.getDni()}";
}
...
class Program
{
    static void Main()
    {
        ...
        Console.WriteLine(miGuardia.controlarDocumento(miVisitante));
